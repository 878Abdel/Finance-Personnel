    ...
    <footer className="bg-[#0D0D1A] text-white py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="font-['Syne'] font-bold text-sm text-white/40 uppercase tracking-widest mb-4">Produit</h4>
            <ul className="space-y-2">
              {['Fonctionnalités', 'Tarifs', 'Sécurité', 'Roadmap'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-white/60 hover:text-[#D0FF00] transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
